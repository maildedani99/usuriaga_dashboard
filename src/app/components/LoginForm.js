...
export default function LoginForm() {
    const { login: authLogin } = useAuth(); // Usamos la función login del contexto
    ...
    const onSignIn = async () => {
        try {
            ...
            if (resLogin.token) {
                authLogin(resLogin.token); // Guardar el token en sessionStorage y actualizar el contexto
                router.push('/dashboard/collection'); // Redirigir al dashboard
            }
        } catch (error) {
